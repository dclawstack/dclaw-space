...
**DClaw Space** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8056` (FastAPI)
- **Frontend Port:** `3056` (Next.js)
- **Database:** `dclaw_space` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3056`
